...
def _setup(context, *args, **kwargs):
    ...
    # Get the path to the wake_word_params.yaml file
    config_dir = get_package_share_directory("speech_recognition")
    config_file = os.path.join(config_dir, "config", "wake_word_params.yaml")
    ...
    return [
        ...
        LogInfo(msg=f"[speech_recognition] Loading wake word config from: {config_file}"),
